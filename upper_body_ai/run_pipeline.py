...
def main():
    print("[START] STARTING COMPLETE IMAGE-ONLY UPPER-BODY AI PIPELINE...")

    # Step 0: Download Real-Life Human Photographs
    run_step("python download_real_dataset.py --count 100", "STEP 0 - Real Human Photo Fetcher & Annotator")

    # Step 1: Generate Synthetic Upper-Body Images
    run_step("python generate_dataset.py --count 600", "STEP 1 - Synthetic Image Generation")

    # Step 2: Quality Filter, Split & Augment Dataset (Real + Synthetic)
    ...
    print("\n" + "="*70)
    print("  [SUCCESS] COMPLETE IMAGE-ONLY UPPER-BODY AI PIPELINE EXECUTED SUCCESSFULLY!")
    print("="*70 + "\n")
